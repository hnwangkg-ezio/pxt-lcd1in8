/***********************************************************************************************************************
* | file      	:	LCD1in8_Driver.cpp
* |	version		:	V1.0
* | date		:	2018-03-12
* | function	:	ST7735S chip driver
***********************************************************************************************************************/
...
function:
			Hardware reset
*******************************************************************************/
void LCD1in8_Driver::LCD_Reset(void)
{
    LCD_RST_1;
    Driver_Delay_ms(100);
    LCD_RST_0;
...
*******************************************************************************/
void LCD1in8_Driver::LCD_WriteReg(uint8_t Reg)
{
    LCD_DC_0;
    LCD_CS_0;
    SPI_Write_Byte(Reg);
...
void LCD1in8_Driver::LCD_WriteData_8Bit(uint8_t Data)
{
    LCD_DC_1;
    LCD_CS_0;
    SPI_Write_Byte(Data);
...
void LCD1in8_Driver::LCD_WriteData_NLen16Bit(uint16_t Data,uint32_t DataLen)
{
    uint32_t i;
    LCD_DC_1;
    LCD_CS_0;
...
*******************************************************************************/
void LCD1in8_Driver::LCD_InitReg(void)
{
    //ST7735R Frame Rate
    LCD_WriteReg(0xB1);
...
function:
			initialization
********************************************************************************/
void LCD1in8_Driver::LCD_Init(LCD_SCAN_DIR Lcd_ScanDir){
...
********************************************************************************/
void LCD1in8_Driver::LCD_SetWindows(POINT Xstart, POINT Ystart, POINT Xend, POINT Yend){
    //set the X coordinates
    LCD_WriteReg(0x2A);
    LCD_WriteData_8Bit(0x00); 
    LCD_WriteData_8Bit((Xstart & 0xff) + sLCD_DIS.LCD_X_Adjust); 
    LCD_WriteData_8Bit(0x00 ); 
    LCD_WriteData_8Bit(((Xend - 1) & 0xff) + sLCD_DIS.LCD_X_Adjust); 
...
parameter:
		...
		xEnd   :   X direction end coordinates
********************************************************************************/
void LCD1in8_Driver::LCD_SetCursor(POINT Xpoint, POINT Ypoint){
...
void LCD1in8_Driver::LCD_SetColor(COLOR Color, POINT Xpoint, POINT Ypoint){
...
parameter:
		...
		Color  :   Set the color
********************************************************************************/
void LCD1in8_Driver::LCD_SetArealColor(POINT Xstart, POINT Ystart, POINT Xend, POINT Yend, COLOR Color){
...
function:
			Clear screen
********************************************************************************/
void LCD1in8_Driver::LCD_Clear(COLOR Color){
