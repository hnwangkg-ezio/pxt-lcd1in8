...
void LCD_GUI::GUI_Swop(POINT Point1, POINT Point2)
{
    POINT Temp;
    Temp = Point1;
    Point1 = Point2;
...
********************************************************************************/
void LCD_GUI::GUI_DrawPoint(POINT Xpoint, POINT Ypoint, COLOR Color,
...
********************************************************************************/
void LCD_GUI::GUI_DrawLine(POINT Xstart, POINT Ystart, POINT Xend, POINT Yend,
...
********************************************************************************/
void LCD_GUI::GUI_DrawRectangle(POINT Xstart, POINT Ystart, POINT Xend, POINT Yend,
...
********************************************************************************/
void LCD_GUI::GUI_DrawCircle(POINT X_Center, POINT Y_Center, LENGTH Radius,
...
********************************************************************************/
void LCD_GUI::GUI_DisChar(POINT Xpoint, POINT Ypoint, const char Acsii_Char,
...
parameter:
			...
			Color_Foreground : Select the foreground color of the English character
********************************************************************************/
void LCD_GUI::GUI_DisString_EN(POINT Xstart, POINT Ystart, const char * pString,
                      sFONT* Font,COLOR Color_Background, COLOR Color_Foreground )
{
    POINT Xpoint = Xstart;
    POINT Ypoint = Ystart;
...
void LCD_GUI::GUI_DisNum(POINT Xpoint, POINT Ypoint, int32_t Nummber,
                sFONT* Font,COLOR Color_Background, COLOR Color_Foreground )
{
...
void LCD_GUI::GUI_Disbitmap(POINT Xpoint, POINT Ypoint, const unsigned char *pBmp,
